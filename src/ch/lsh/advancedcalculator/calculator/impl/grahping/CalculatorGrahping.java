package ch.lsh.advancedcalculator.calculator.impl.grahping;
...
public class CalculatorGrahping extends Calculator implements ActionListener, ChangeListener {
	...
	public CalculatorGrahping() {
		super("Graphing", 500, 600);
	}

	@Override
	public JFrame execute() {
        /*INITIALIZE WINDOW (JFRAME)*/
        JFrame window = new JFrame("Advanced Calculator - " + getCalculator());
